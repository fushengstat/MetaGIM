# main procedure for gim-independent 
gim_ind <- function(models,group,sample.info,form,family,data,scores){
...
gimref_ind <- function(models,group,sample.info,form,family,data,ref,scores,scorer){
  ncase = sample.info$ncase
  nctrl = sample.info$nctrl
