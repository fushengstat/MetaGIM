...
meta_gimref <- function(models,group,sample.info,form,family,data,ref){
  ...
  outcome0 = outcome[[1]]
  daty = data[, outcome0]
  Inew = nCov_ref(npara,nmap,score_ref,score_int,daty,n.para,J0,Sig0)
  ...
  list(coef.r = coef1, coef.i = coef2, vcov.r = vcov1, vcov.i = vcov2)
  
}



meta_gimref_rho <- function(models,group,sample.info,form,family,data,ref,cut0){
  ncase = sample.info$ncase
  nctrl = sample.info$nctrl
